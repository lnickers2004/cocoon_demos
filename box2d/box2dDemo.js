...
(function() {
    ...
    function demo(img) {
        ...
        ctx.drawImage( images[3].image,0,0 );
        ...
        // else
            window.addEventListener('deviceorientation', function (event) {
                        box2Dworld.SetGravity( new Box2D.Common.Math.b2Vec2((0.5 + event.beta) * GRAVITY * 0.01 , -event.gamma * GRAVITY * 0.01)) ;
            }, true);
        
        
        var WORLD_WIDTH  = 960/PTM; 
        var WORLD_HEIGHT = 640/PTM;
