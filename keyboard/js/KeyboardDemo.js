    ...
    CocoonJS.Button.prototype= {
        ...
        repaint : function(text) {
            ...
            if ( text && text!=="" ) {
                ...
                this.ctx.font= font;
                this.ctx.fillText( text, this.x+300, this.y+this.image.height/2 ); //canvas.width/2, canvas.height/2 );
            }
        ...
        handle : function( x, y ) {
            ...
            if ( x>=this.x && x<=this.x+this.image.width && y>=this.y && y<=this.y+this.image.height ) {
                CocoonJS.App.showTextDialog( "Title", "Message", "Initial", this.type, "Cancel", "Ok" );
                return true;
            }
...
(function() {
    ...
    function demo(img) {
        ...
        var data= [
            CocoonJS.App.KeyboardType.TEXT,
            CocoonJS.App.KeyboardType.EMAIL,
            CocoonJS.App.KeyboardType.NUMBER,
            CocoonJS.App.KeyboardType.URL,
            CocoonJS.App.KeyboardType.PHONE
        ];
